defmodule AssisiWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      AssisiWeb.Coherence.ViewHelps.coherence_links/3
  ...
  import AssisiWeb.Gettext

  @type conn :: Plug.Conn.t()
  @type schema :: Ecto.Schema.t()

  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers AssisiWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AssisiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AssisiWeb.Gettext, "errors", msg, opts)
    end
  end
